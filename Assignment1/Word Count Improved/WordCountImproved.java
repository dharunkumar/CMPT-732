...
public class WordCountImproved extends Configured implements Tool {
	...
	extends Mapper<LongWritable, Text, Text, LongWritable>{
		...
		public void map(LongWritable key, Text value, Context context
			...
			ArrayList <String> puncIgnoredStrings = new ArrayList<String> ();
			while(itr.hasMoreTokens()){
				Collections.addAll(puncIgnoredStrings, word_sep.split(itr.nextToken().toLowerCase()));
			}
			for (String string : puncIgnoredStrings) {
				word.set(string);
